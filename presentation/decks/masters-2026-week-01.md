...
author: НИУ ВШЭ
info: |
  Неделя 1 магистерского курса классического машинного обучения.
...
defaults:
  ...
  class: text-[24px]
appendixSlides: 3
exportFilename: masters-2026-week-01
download: false
---

<!-- S01 -->

<div class="section-kicker">Классическое машинное обучение · Магистратура · Неделя 1</div>
...
# Маршрут курса · Встречи 1–3

<ol class="text-[23px] space-y-7 mt-8">
  ...
  <li><strong>Линейная модель, функция потерь и обучение</strong><br><span class="muted">МНК · матричная запись · остатки · градиентный спуск</span></li>
  <li><strong>Вероятностная классификация и решение</strong><br><span class="muted">логистическая регрессия · метрики · пороги · калибровка</span></li>
</ol>
...
# Маршрут курса · Встречи 4–6

<ol start="4" class="text-[23px] space-y-7 mt-8">
  <li><strong>Выбор модели и честный эксперимент</strong><br><span class="muted">регуляризация · cross-validation · Pipeline · утечки · короткий контраст kNN</span></li>
  <li><strong>Деревья и Random Forest</strong><br><span class="muted">разбиения · сложность · нестабильность · усреднение</span></li>
  <li><strong>Градиентный бустинг и современные реализации</strong><br><span class="muted">исправление прогноза · псевдоостатки · CatBoost/XGBoost/LightGBM</span></li>
</ol>
...
# Маршрут курса · Встречи 7–8

<ol start="7" class="text-[25px] space-y-9 mt-10">
  <li><strong>Настройка, диагностика и эксперимент целиком</strong><br><span class="muted">поиск гиперпараметров · анализ ошибок · интерпретация · ограничения</span></li>
  <li><strong>Защита проектов</strong><br><span class="muted">перенос общего ML-подхода в новую область</span></li>
</ol>

<div class="key-line mt-12 text-[25px]">Семь содержательных встреч и защита на восьмой. Коллоквиума нет.</div>
...
<div class="text-center mt-9 text-[26px]">

$$
\text{Итог}
=\text{ДЗ}_1+\text{ДЗ}_2+\text{Проект}+\text{Активность/посещаемость}
$$
...
<div class="grid grid-cols-2 gap-x-12 gap-y-5 mt-8 text-[23px]">
  <div>ДЗ 1 / ДЗ 2 — <strong>по 2 балла</strong></div>
  <div>Проект — <strong>4 балла</strong></div>
  <div>Активность/посещаемость — <strong>2 балла</strong></div>
  <div>Коллоквиума <strong>нет</strong></div>
</div>

<div class="success-line mt-8 text-2xl text-center">Отдельного итогового экзамена нет.</div>
...
<div class="term-grid grid grid-cols-2 gap-10 mt-10 text-center max-w-3xl mx-auto">
  <div><strong class="text-[#2864dc]">ДЗ 1</strong><br><span class="muted">2 балла</span></div>
  <div><strong class="text-[#2864dc]">ДЗ 2</strong><br><span class="muted">2 балла</span></div>
</div>

<div class="mt-8 text-[23px]">Постановки, сроки и критерии проверки будут объявлены отдельно.</div>
...
<div class="plain-columns grid grid-cols-1 gap-12 mt-8 text-[23px]">
  <div><strong>Материалы курса</strong><p>Лекции, слайды и семинары публикуются по мере готовности.</p><p><a href="https://github.com/YuZinyakoff/classic-ml-course">Репозиторий курса</a></p></div>
</div>
...
<div class="text-center mt-4 text-[40px] font-700 text-[#2864dc]">4 балла</div>
...
<ul class="text-[25px] space-y-5">
  ...
  <li>Оценка складывается из двух домашних работ, проекта и активности/посещаемости.</li>
</ul>
</div>
...
<strong>Следующая неделя:</strong> линейная регрессия, функции потерь и обучение модели.
</div>
